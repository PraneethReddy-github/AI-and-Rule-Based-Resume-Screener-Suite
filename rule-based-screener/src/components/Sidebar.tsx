  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-logo">
        ...
        <div>
          <div className="sidebar-logo-text">ResumeScreen</div>
          <div className="sidebar-logo-sub">Rule-Based Triage</div>
        </div>
      </div>
          ...
          <>
            ...
            {jobDescriptions.map((jd) => (
              ...
              >
                ...
                {jd.resumeCount > 0 && <span className="nav-badge">{jd.resumeCount}</span>}
              </NavLink>
            ))}
          </>
        )}
      ...
      <div style={{ fontSize: 11, color: 'var(--text-tertiary)', padding: '12px 10px', lineHeight: 1.5 }}>
        All processing happens in your browser. <br />No server. Fully private.
      </div>
    </aside>
  );
}
